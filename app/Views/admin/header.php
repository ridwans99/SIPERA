    ...
    <div class="main-header">
      ...
      <div class="logo-header" data-background-color="blue">
        <a href="<?php echo base_url().'admin'; ?>" class="logo">
          <img width="30" src="<?php echo base_url().'assets_v2/img/logo.png'?>">   
        </a>
        <p style="color: black; margin-top: 15px; margin-left: 20px; size: 35px;">SIPERA</p>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="peminjaman">
              <ul class="nav nav-collapse">
                <li>
                  <a href="<?php echo base_url().'admin/peminjamanruangan'; ?>"> 
                    <p>Transaksi Peminjaman Ruangan</p>
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url().'admin/peminjamanbarang'; ?>"> 
                    <p>Transaksi Peminjaman Barang</p>
                  </a>
                </li>
              </ul>
            </div>
