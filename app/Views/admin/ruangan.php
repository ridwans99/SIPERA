<div class="main-panel"><br>
      ...
      <div class="panel animated fadeIn slower">
        <div class="card">
          <div class="card-header bg-dark">
            <div class="card-title text-white"><i class="fas fa-home text-white"></i> Daftar Ruangan</div>
          </div>
          <div class="card-body">
            <button style="margin-left: 15px;" type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target=".modal-tambah-ruangan"><i class="fas fa-plus"></i> Tambah Ruangan</button>
  ...
  <!-- Modal Tambah Buku -->
    <div class="modal fade modal-tambah-ruangan" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header bg-dark">
            <h5 class="modal-title" id="exampleModalLongTitle" style="color: #fff;"><i class="fas fa-home"> </i><b> Tambah Ruangan</b></h5>
              ...
              <div class="col-md-6">
                <form action="<?php echo base_url().'admin/tambah_buku_act' ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="judul_buku" class="form-control" placeholder="Ruangan" autocomplete="off">
                    <?php echo form_error('judul_buku'); ?>
                  </div>

                  <div class="form-group">
                    <label><i class="fas fa-book-open text-dark"></i> Deskripsi</label>
                    <input type="text" name="pengarang" class="form-control" placeholder="Deskripsi" autocomplete="off">
                  </div>
