...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url('Admin/updateInputData') ?>" method="post" class="data" enctype="multipart/form-data">
                        <input name="input_id" value="<?= $tampildata['input_id']; ?>" hidden>
                        <div class="form-group">
                            <label>Nama Ruangan</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" value="<?= $tampildata['ruangan_id']; ?>" placeholder="" name="ruang">
                            </div>
                        </div>
                        <div class="form-group">
